...
/***/ function(module, exports, __webpack_require__) {
	...
	var P2P = __webpack_require__(168);
	...
	ReactDOM.render(React.createElement(P2P, { opts: options }), main);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Peer = __webpack_require__(169);
	...
	module.exports = React.createClass({
		...
		componentWillMount: function componentWillMount() {
			...
			this.state.peer.on('connection', function (connection) {
				...
				_this.setState({
					...
					_this.state.conn.on('data', _this.onReceiveData);
				});
			});
		},
		...
		connect: function connect() {
			...
			this.setState({
				...
				_this2.state.conn.on('data', _this2.onReceiveData);
			});
		},

		onReceiveData: function onReceiveData(data) {
			var dataReceived = this.state.dataReceived;
		...
		handleTextForP2P: function handleTextForP2P(event) {
			this.setState({
		...
		onSendData: function onSendData() {
			...
			var conn = _state2.conn;
			var dataToSend = _state2.dataToSend;
		...
		renderNotConnected: function renderNotConnected() {
			return React.createElement(
				...
				React.createElement(
					'div',
					null,
					React.createElement('input', { type: 'text', onChange: this.handleTextChange })
				),
				React.createElement(
					'button',
		...
		renderConnected: function renderConnected() {
			var dataReceived = this.state.dataReceived;
			...
			return React.createElement(
				...
				React.createElement(
					'h2',
					null,
					'We are P2P connected!'
				),
				React.createElement('input', { type: 'text', onChange: this.handleTextForP2P }),
				React.createElement(
					'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MediaConnection = __webpack_require__(176);
	var DataConnection = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BinaryPack = __webpack_require__(171);
	var RTCPeerConnection = __webpack_require__(173).RTCPeerConnection;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BufferBuilder = __webpack_require__(172).BufferBuilder;
	var binaryFeatures = __webpack_require__(172).binaryFeatures;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var util = __webpack_require__(170);
	var EventEmitter = __webpack_require__(174);
	var Negotiator = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var util = __webpack_require__(170);
	var RTCPeerConnection = __webpack_require__(173).RTCPeerConnection;
	var RTCSessionDescription = __webpack_require__(173).RTCSessionDescription;
	var RTCIceCandidate = __webpack_require__(173).RTCIceCandidate;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventEmitter = __webpack_require__(174);
	var Negotiator = __webpack_require__(177);
	var Reliable = __webpack_require__(179);
